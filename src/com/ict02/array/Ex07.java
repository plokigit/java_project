...
public class Ex07 {
		public static void main(String[] args) {
			...
			//1. 고정길이 배열
			//1) 선언 : 자료형[][] 이름;
			//2) 생성 : 이름 = new 자료형[숫자][숫자];
			//3) 저장 : 이름[index][index] = 데이터; (고정길이에서만 사용)
			//			1차원 배열을 만들어서 다른 배열에 넣기(고정, 가변 둘다 O)
			
			int [][] k1;
			k1 = new int[2][4]; // 둘 다 안쓰면 오류남
			...
			// 1차원 배열을 만들어서 다차원 배열에 넣기(고정, 가변길이 모두 사용 O)
