...
public abstract class Ex01 {
	...
	//				 일반적인 메소드와 필드르 가질 수 있다
	//				 추상클래스는 반드시 abstract 예약어를 사용
	
	// 추상 메소드 : 구체화 되지 않은 메소드를 의미한다
	//				 body 블록이 존재하지 않는 메소드를 말한다
	//				 body 블록이 없으면 실행문도 없다(=구체화 되지 않음)
	//				 추상메소에는 반드시 abstract 예약어를 사용한다
