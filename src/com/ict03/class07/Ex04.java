...
public class Ex04 {
	...
	public static class Inner03 {
		...
		// 강제로 static 사용하고자 하면 내부클래스에도 static 붙이자
		static int i3 = 20;
		static final int i4 = 30;
		
		public Inner03() {
			System.out.println("내부클래스생성자 : " + this);
		}
		...
		public void play() {
			...
			System.out.println("금액 : "+money);	// private도 접근 O
			// 외부클래스의 필드 static을 붙여야함
			// System.out.println("나이 : "+age);
			// 외부클래스 메소드 static 붙여야 사용가능
			// sound();
		}
	}
}
